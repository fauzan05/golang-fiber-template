<a href="/toko_online/public/admin/productManagement" class="a-back" ><p class="fa-sharp fa-solid fa-arrow-left"></p> Back</a>
    ...
    <form action="/toko_online/public/admin/editProduct" method="post" enctype="multipart/form-data">
        <div class="form-edit-product1">
            <input type="text" name="id" style="display: none;" value="<?= $model['productId'] ?? '' ?> "/>
            <div class="input-group">
                <label for="image" class="register-label">Image</label>
                <img class="img-product-edit" src="<?= $model['imageLocation'] . $model['productImage'] ?? '' ?>">
                <input type="file" name="image" id="image"/>
                <p><?= $model['productImage']?></p>
            </div>
            <div class="input-group">
                <label for="name" class="register-label">Name</label>
                <input type="text" name="name" class="register-input" placeholder="name" id="name" value="<?= $model['productName'] ?? '' ?>"/>
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="price" class="register-input" placeholder="price" value="<?= $model['productPrice'] ?? '' ?>"/>
            </div>
            <button class="edit-product-button"><a class="a">Save</a></button>
        </div>
        <div class="form-edit-product2">
            <div class="input-group">
                <label for="stock" class="register-label">Stock</label>
                <input type="text" name="stock" class="register-input" placeholder="stock" value="<?= $model['productStock'] ?? '' ?>"/>
            </div>
            <div class="input-group">
                <label for="color" class="register-label">Color</label>
                <select name="color" id="color" value="<?= $model['productColor'] ?? '' ?>">
