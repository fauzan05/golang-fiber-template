  ...
  <br>
  <a href="#" class="directory">Home/ Product Search Result</a>
  <br>
  <br>
  <hr>
  <main class="grid">
    <article>
      <a href="#">
        <img src="http://localhost/toko_online/public/assets/images/iphoneX.png" alt="">
        <div class="content">
          <h2>iPhone X</h2>
          <p>This is an iPhone X</p>
        </div>
      </a>
    </article>
    <article>
      <a href="#">
        <img src="http://localhost/toko_online/public/assets/images/iphone6splus.png" alt="">
        <div class="content">
          <h2>iPhone 6s Plus</h2>
          <p>This is an iPhone 6s Plus</p>
        </div>
      </a>
    </article>
    <article>
